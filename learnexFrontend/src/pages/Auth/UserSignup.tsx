...
const UserSignup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authService.userSignup(userName, password);
      login(response.token, false); // false indicates regular user, not admin
      navigate('/dashboard');
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 relative">
        {/* Glow effect */}
        <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 to-green-600/20 rounded-2xl blur-xl"></div>
        ...
        <div className="relative bg-gray-800/90 backdrop-blur-sm p-8 rounded-xl border border-gray-700/50">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white">Create Student Account</h2>
            <p className="text-gray-400 mt-2">Join CyberEdu and start your learning journey</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-200"
