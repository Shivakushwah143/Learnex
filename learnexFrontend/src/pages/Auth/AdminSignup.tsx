...
const AdminSignup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authService.adminSignup(userName, password);
      ...
      <div className="max-w-md w-full space-y-8 relative">
        ...
        <div className="relative bg-gray-800/90 backdrop-blur-sm p-8 rounded-xl border border-gray-700/50">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white">Create Instructor Account</h2>
            <p className="text-gray-400 mt-2">Join CyberEdu as an instructor and share your expertise</p>
          </div>
