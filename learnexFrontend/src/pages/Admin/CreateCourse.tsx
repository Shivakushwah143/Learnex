      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">
            Create New <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Course</span>
          </h1>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full pl-10 pr-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all duration-200 resize-none"
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-white font-medium">
                      {formData.publish ? 'Publish Course' : 'Save as Draft'}
                    </div>
